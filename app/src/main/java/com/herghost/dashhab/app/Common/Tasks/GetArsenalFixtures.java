 ...
 */
public class GetArsenalFixtures extends AsyncTask<Void,Void,Void> {
    ...
    public GetArsenalFixtures(Context _ctx, Callbacks _cb)
    {
        this.ctx = _ctx;
        this.cb = _cb;
    }
    ...
    protected Void doInBackground(Void... voids) {
        ...
        {
            if(r.displayName.equals("Arsenal") && r.accountName.equals("mygmail"))
            {
